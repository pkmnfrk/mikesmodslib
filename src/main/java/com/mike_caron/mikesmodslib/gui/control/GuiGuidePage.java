    ...
    implements GuiButton.ClickedListener
{
    ...
    public void loadPage(String uri)
    {
        ...
        if(yPos > this.height)
        {
            ...
            //reflow everything
            //Mod.logger.info("Reflowing due to scroll bar");
            yPos = 4;
            for(GuiControl control : controls)
            {
                ...
                control.setY(yPos);
                //Mod.logger.info("Setting yPos of " + control + " to " + yPos + " with height of " + control.getHeight());
    ...
    private void insertLabel(JsonObject translation, JsonElement l, boolean isTitle)
    {
        if(l.isJsonPrimitive())
        {
            ...
            if(p.isString())
            {
                ...
                //Mod.logger.info("Setting yPos of " + label + " to " + yPos + " with height of " + label.getHeight());
