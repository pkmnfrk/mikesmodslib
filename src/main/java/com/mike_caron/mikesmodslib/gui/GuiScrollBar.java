    ...
    extends GuiSized
{
    ...
    public void draw()
    {
        ...
        GuiUtil.drawStretchedTexturePart(0, 0, this.width, this.width, GFX_X, GFX_Y, 8, 8, 256, 256);
        GuiUtil.drawStretchedTexturePart(0, this.height - this.width, this.width, this.width, GFX_X, GFX_Y + 8, 8, 8, 256, 256);
        GuiUtil.drawTexturePart(0, this.width + nubY, 8, 8, GFX_X + 8, GFX_Y + 8, 256, 256);
    }
