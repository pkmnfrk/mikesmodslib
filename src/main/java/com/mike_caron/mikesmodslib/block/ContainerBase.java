        ...
        implements IGuiUpdater
{
    ...
    public final NBTTagCompound serializeNBT()
    {
        ...
        //Mod.logger.info("serializeNBT:");
        //Mod.logger.info(StringUtil.prettyPrintJson(DataUtils.toJson(tag)));
    ...
    protected void triggerUpdate()
    {
        ...
        for(IContainerListener listener : this.listeners)
        {
            ...
            {
                Mod.networkWrapper.sendTo(message, (EntityPlayerMP) listener);
            }
        }
    }
