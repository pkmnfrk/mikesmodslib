...
public class TOPCompatibility
{
    ...
    public static void register()
    {
        ...
        registered = true;
        FMLInterModComms.sendFunctionMessage("theoneprobe", "getTheOneProbe", "com.mike_caron.mikesmodslib.integrations.TOPCompatibility$GetTheOneProbe");
    }
            ...
            implements Function<ITheOneProbe, Void>
    {
        ...
        {
            probe = iTheOneProbe;
            Mod.logger.info("Enabled support for The One Probe. Most excellent.");
            probe.registerProvider(new IProbeInfoProvider()
            {
                @Override
                public String getID()
                {
                    return Mod.modId + ":default";
                }
